...
export const LOCAL_POSTS = [
  ...
  {
    _id: 'local-real-estate-marketing-strategy-dubai',
    title: 'The Real Estate Marketing Funnel Is Broken: Why Developers Need a Revenue Architecture',
    slug: 'real-estate-marketing-strategy-dubai',
    category: 'article',
    excerpt:
    ...
    seoTitle: 'Real Estate Marketing Strategy Dubai | Sharoon Irfan',
    metaDescription:
      'Why the real estate marketing funnel fails in Dubai, and how developers can build a revenue marketing system connecting positioning, CRM, sales and attribution.',
    publishedAt: '2026-08-19T09:00:00.000Z',
    modifiedAt: '2026-08-19T09:00:00.000Z',
    featured: true,
    readTimeOverride: 7,
    coverImage: {
      isLocal: true,
      src: '/images/thought-room/revenue-architecture.jpg',
      alt: 'An open coffee-table book showing a dark concept car illustration',
      width: 736,
      height: 981,
    },
    body: [
      h2('The Real Estate Marketing Funnel Is Broken'),
      p(
      ...
      h2('More Leads Don’t Automatically Mean More Revenue'),
      p(
      ...
      p('Imagine a campaign generating 1,000 enquiries. If the business doesn’t know:'),
      bullet([{ text: 'which audience generated the enquiries' }]),
      bullet([{ text: 'which campaign created qualified demand' }]),
      bullet([{ text: 'how quickly leads were contacted' }]),
      bullet([{ text: 'where leads dropped off' }]),
      bullet([{ text: 'which channels generated actual sales' }]),
      bullet([{ text: 'which messaging produced the strongest intent' }]),
      p(
      ...
      quote('Leads are an input. Revenue is the outcome.'),

      h2('Dubai Real Estate Requires a Different Approach'),
      p(
      ...
      p('Developers need to answer a more important question first:'),
      rich([{ text: 'Why should a buyer choose this project over the alternatives?', strong: true }]),
      p('That question starts before the campaign is built. It starts with positioning.'),

      h2('Positioning Comes Before Performance'),
      p(
        'Performance marketing can amplify demand. It cannot create a compelling proposition out of nothing.'
      ),
      p('Before launching campaigns, developers should be clear about:'),
      bullet([{ text: 'Who is the project for?' }]),
      bullet([{ text: 'What problem or aspiration does it address?' }]),
      bullet([{ text: 'Why is this project different?' }]),
      bullet([{ text: 'Why should the buyer believe the promise?' }]),
      bullet([{ text: 'Why should they act now?' }]),
      p(
      ...
      bullet([{ text: 'Brand strategy' }]),
      bullet([{ text: 'Website' }]),
      bullet([{ text: 'Content' }]),
      bullet([{ text: 'Paid media' }]),
      bullet([{ text: 'Sales presentations' }]),
      bullet([{ text: 'CRM communication' }]),
      bullet([{ text: 'Broker communication' }]),
      bullet([{ text: 'Sales conversations' }]),
      p('When the positioning is fragmented, the customer experience becomes fragmented too.'),

      h2('From Funnel to Revenue Architecture'),
      rich([
        { text: 'I think about real estate marketing as a connected ' },
        { text: 'system', href: '/#system' },
        { text: ' rather than a traditional funnel. A strong revenue architecture connects five layers.' },
      ]),
      h3('1. Positioning'),
      p('Define the market opportunity, audience, proposition and differentiation.'),
      h3('2. Demand Generation'),
      p(
      ...
      h3('4. CRM and Sales'),
      rich([
        { text: 'Capture, qualify, nurture and distribute demand intelligently through the ' },
        { text: 'CRM', href: '/#crm-attribution' },
        { text: ' rather than treating every lead the same way.' },
      ]),
      h3('5. Measurement and Attribution'),
      p(
        'Connect marketing activity to pipeline and revenue so the business can understand what is actually working.'
      ),
      p('The important part is not any individual layer. It is the connection between them.'),

      h2('The CRM Should Not Be an Afterthought'),
      p(
      ...
      bullet([{ text: 'Which campaigns are generating qualified buyers?' }]),
      bullet([{ text: 'Which audiences are converting?' }]),
      bullet([{ text: 'Which leads need nurturing?' }]),
      bullet([{ text: 'Which sources generate transactions rather than just enquiries?' }]),
      bullet([{ text: 'Where are prospects dropping out of the journey?' }]),
      bullet([{ text: 'What does the sales team need from marketing?' }]),
      p('Without this feedback loop, marketing continues optimising for surface-level metrics:'),
      bullet([{ text: 'Clicks' }]),
      bullet([{ text: 'Reach' }]),
      bullet([{ text: 'Cost per lead' }]),
      bullet([{ text: 'Lead volume' }]),
      p('But none of these metrics necessarily tell you whether the business is creating revenue.'),

      h2('Marketing and Sales Need One System'),
      p('Marketing should not simply hand leads to sales and move on. The relationship needs to be continuous.'),
      p(
      ...
      rich([
        {
          text: 'Market → Message → Campaign → Lead → Sales → CRM → Revenue → Insight → Better Marketing',
          strong: true,
        },
      ]),
      p('That loop is where sustainable growth starts.'),

      h2('The New Real Estate Marketing KPI'),
      p('The question should no longer be “how many leads did marketing generate?” The better questions are:'),
      bullet([{ text: 'How much qualified demand did marketing create?' }]),
      bullet([{ text: 'How much pipeline did it influence?' }]),
      bullet([{ text: 'Which channels created revenue?' }]),
      bullet([{ text: 'Which audiences converted?' }]),
      bullet([{ text: 'Which campaigns should we scale?' }]),
      p(
      ...
      h2('What Developers Should Build'),
      rich([
        {
          text: 'A modern real estate marketing system should connect brand, positioning, performance, website, CRM, sales and analytics — not as separate departments run against separate ',
        },
        { text: 'services', href: '/#services' },
        { text: ', but as one system.' },
      ]),
      p(
      ...
      p('That is the difference between running campaigns and building a revenue engine.'),

      h2('Final Thought'),
      p('Dubai real estate doesn’t need more marketing noise. It needs better marketing systems.'),
      p(
      ...
      richBlock('closingLine', [{ text: 'Marketing should not end when a lead is generated.' }]),
      richBlock('closingLine', [{ text: 'That is where the revenue journey begins.' }]),

      rich([
        {
          text: 'If part of your funnel is leaking and you can’t yet see where, that’s usually a conversation worth having before it’s a campaign worth running. ',
        },
        { text: 'Get in touch', href: '/#contact' },
        { text: ', or read more working notes like this one in the ' },
        { text: 'Thought Room', href: '/thought-room' },
        { text: '.' },
      ]),
      rich([
        ...
        { text: 'Revenue Marketing Architect', href: '/#about' },
        {
          text: ' focused on building marketing systems that connect go-to-market strategy, performance marketing, CRM, positioning and revenue — particularly for Dubai real estate and developer-led launches. Read more on ',
        },
        {
          text: 'why real estate marketing needs a revenue system',
          href: '/thought-room/insights/real-estate-marketing-revenue-system',
