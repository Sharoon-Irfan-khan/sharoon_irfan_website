...
export const services = {
  ...
  // the page went from a photograph straight into numbered cards with no
  ...
  //
  // The count is in the copy, so it has to move when the list does: this read
  // "Seven services" until the Developer Experience card was dropped.
  title: 'Six services. One system.',
  ...
  items: [
    ...
    },
    {
      ...
      // Was 'crm-attribution', the photograph of a tablet contact form. This
      // one carried the seventh card until that service was dropped, and it is
      // the better picture of the same idea — data circling back to a person.
      image: 'devex-code',
