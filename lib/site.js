...
export const site = {
  ...
  // Supplied 31 July as JPEGs on a flat white card. The white is cut to
  // transparency and the edges trimmed, because the footer is dark and a white
  // square around a logo reads as a mistake. Sized to 120px on the long edge,
  // which is roughly twice what they render at.
  //
