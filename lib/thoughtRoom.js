...
export const CATEGORIES = [
  { id: 'article', path: 'articles', label: 'Articles', note: 'Original thinking' },
  {
    id: 'case-study',
    path: 'case-studies',
    label: 'Case Studies',
  ...
  { id: 'signal', path: 'signals', label: 'Industry Signals', note: 'Reading the market' },
];
