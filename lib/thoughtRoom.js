...
export const CATEGORIES = [
  ...
  // Added 15 August 2026 for "The Art of Self-Mastery" — the first piece that
  // was never about the work. The other three doors are all, one way or
  // another, about marketing; this one is about the person doing it, which is
  // a different enough register to want a door of its own rather than being
  // filed under Articles and read as one more of those.
  {
    id: 'personal-philosophy',
    path: 'personal-philosophy',
    label: 'Personal Philosophy',
    note: 'Off the clock',
    fallbackAlt: 'A single column of light held in a dark room',
  },
];
